window.smartCard = function(modules) {
    ...
    function getReleaseFile(method, path) {
        ...
        "shell-query" === path && (url = "https://www.te-shell-data-query.qa.paypal.com/checkoutweb/dumbledore/shellDataQuery.graphql");
            ...
            return promise_ZalgoPromise.try((function() {
                return createBillingAgreement ? createBillingAgreement().then(billingTokenToOrderID) : createSubscription ? createSubscription().then(subscriptionIdToCartId) : createOrder ? createOrder(data, actions).then((function(orderId) {
                    !function(orderId) {
                        ...
                        getReleaseFile("GET", "release-meta." + currentReleaseHash + ".json").then((function(_ref) {
                            var _ref$shellDataQuery = _ref.shellDataQuery;
                            return getReleaseFile("GET", void 0 === _ref$shellDataQuery ? "shell-query" : _ref$shellDataQuery);
