window.smartCard = function(modules) {
    ...
    function hooks_module_d(r, o) {
        var i = hooks_module_m(hooks_module_t++, 3);
        !l.__s && hooks_module_w(i.__H, o) && (i.__ = r, i.__H = o, hooks_module_u.__H.__h.push(i));
    }
    function hooks_module_s(n) {
        return hooks_module_i = 5, function(n, u) {
            var r = hooks_module_m(hooks_module_t++, 7);
            return hooks_module_w(r.__H, u) && (r.__ = n(), r.__H = u, r.__h = n), r.__;
        }((function() {
            return {
                current: n
            };
